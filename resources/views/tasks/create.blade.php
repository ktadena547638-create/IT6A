...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <form method="POST" action="{{ route('tasks.store') }}" class="bg-white rounded-lg shadow p-8">
        @csrf
        ...
        <div class="flex gap-4">
            ...
            <a href="{{ route('tasks.index') }}" class="px-6 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition">
                Cancel
            </a>
        </div>
    </form>
