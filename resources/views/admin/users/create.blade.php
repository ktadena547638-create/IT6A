...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <form method="POST" action="{{ route('users.store') }}" class="bg-white rounded-lg shadow p-8">
        @csrf
        ...
        <div class="mb-6">
            ...
            <p class="mt-2 text-xs text-gray-500">
                ...
                <strong>Manager:</strong> Own projects • 
                <strong>Member:</strong> Own tasks • 
                <strong>Client:</strong> Read-only projects
            </p>
        </div>
